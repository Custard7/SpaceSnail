        ...
        Disposable
{
    ...
    {
        SWINDLER( "Sound/Music/swindler_cue_jam.mp3" ),
        MENU_MUSIC( "Sound/Music/verse_of_time.wav" ),
        TIN_HATS( "Sound/Music/tin-hats.wav" ),
        BEN_SOUND( "Sound/Music/bensound_dance.mp3" ),
        KIDNAPPING("Sound/Music/kidnapping_is_fun.mp3");
