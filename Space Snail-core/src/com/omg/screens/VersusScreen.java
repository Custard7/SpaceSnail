...
public class VersusScreen implements Screen {
    ...
    public VersusScreen(SpaceSnail gameManager, GameScreen previousScreen, ABCDDialogue d){
	...
	public void show() {
        ...
        textures = new HashMap<String, Texture>();
  		...
  		battleBackground = new JSActor(new TextureRegion(SpaceSnail.getAssetsManager().getTexture("Battle Back"),0,0,640,360));
  		...
  		JSAnimation enemyAnimation = new JSAnimation("LookingEvil", SpaceSnail.getAssetsManager().getTexture("Enemy_Eye_Front"), 300, 200, 10, 100);
  		...
  		battleBottomBack = new JSActor(new TextureRegion(SpaceSnail.getAssetsManager().getTexture("QBox"),0,0,1280,250));
        ...
        a3Text = new JSFont("C: ");
  		...
  		battleBottom.addActor(a3Text);
	   	...
	   	JSAnimation kikuAnimation = new JSAnimation("Back", SpaceSnail.getAssetsManager().getTexture("Kiku_Back"), 550, 400, 1, 10000);
